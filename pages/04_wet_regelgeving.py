...
_Hier volgt een overzicht van de belangrijkste veranderingen die voor jouw organisatie van belang zijn:_
...
-	**Verlies van ketenpartners**: Gebrek aan transparantie en inzicht verlaagt de incentive voor rapportageplichtige bedrijven om met je samen te werken
    ...
    st.page_link("pages/04x_tabel.py", label = "**Klik hier voor een volledig overzicht van relevante wet- en regelgeving**")
